...
envDATABASE_URL=jdbc:postgresql://localhost:5432/triply_db
...
Create a Firebase Account: If you don't have a Firebase account, go to Firebase and sign up.
Create a Firebase Project: Once you have an account, create a new project in Firebase. This is where your app will connect to Firebase services.
Enable Firebase Authentication: In your Firebase project, go to the Authentication section and enable the authentication methods you want to use (Email/Password, Google, etc.).
Enable Firebase Storage: Go to the Storage section in your Firebase project and enable it. This will be used to store trip photos.
Get Your Firebase Key: After setting up your project, Firebase will give you a service account key in the form of a JSON file. This file contains important information your app needs to connect to Firebase.
Save the JSON File: Download this JSON file and place it in the src/main/resources folder of your project with the name firebase-service-account.json. Without this file, the app won't be able to connect to Firebase.
Configure Firebase in Your Application: The application is already configured to read the Firebase credentials from the JSON file. Make sure the file is in the correct location.
...
<img width="279" height="663" alt="Captura de pantalla 2025-11-03 a las 8 24 36" src="https://github.com/user-attachments/assets/c0c8e3b7-6bbb-4cdd-b23d-f2d0e4a5810e" />
...
Yolanda Alfonso: @yolandaalfonso

Frontend:

Frontend Repository: Triply Frontend
